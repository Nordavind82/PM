...
def validate_trace_data(
    ...
    Args:
        ...
        max_inf_fraction: Maximum allowed Inf fraction
...
def validate_velocity(
    ...
    min_valid: float = 500.0,
    max_valid: float = 10000.0,
    max_gradient: float = 10.0,  # m/s per ms
) -> ValidationResult:
    """
    ...
    Args:
        ...
        min_valid: Minimum valid velocity (m/s)
        max_valid: Maximum valid velocity (m/s)
        max_gradient: Maximum velocity gradient (m/s per ms)
