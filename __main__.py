...
def cmd_wizard(args: argparse.Namespace) -> int:
    ...
    print_info("Interactive wizard not yet implemented.")
    print_info("Use 'pstm run config.json' with a configuration file.")
    return 0
...
def cmd_run(args: argparse.Namespace) -> int:
    ...
    print_info("Migration execution not yet implemented.")
...
def cmd_benchmark(args: argparse.Namespace) -> int:
    ...
    print_info("Benchmark not yet implemented.")
    return 0
